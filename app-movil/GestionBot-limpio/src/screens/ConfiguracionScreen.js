  ...
  const guardarConfiguracion = async () => {
    ...
    try {
      ...
      const datosActualizados = {
        ...
        numero_dueño: config.numero_dueño, // Mantener el original
        numeros_dueños: config.numeros_dueños, // Mantener el original
        grupo_notificaciones: config.grupo_notificaciones, // Mantener el original
      };
