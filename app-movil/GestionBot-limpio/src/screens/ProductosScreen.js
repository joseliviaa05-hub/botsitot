...
const ProductosScreen = ({ navigation, route }) => {
  ...
  // ✅ NUEVO: Manejar parámetros de navegación (desde escáner)
  useEffect(() => {
  ...
  // ✅ NUEVO: Abrir escáner de códigos de barras (COMENTADO)
  // const abrirEscaner = () => {
  ...
  const renderHeader = () => (
    <View style={styles.headerContainer}>
      ...
      <View style={styles.searchRow}>
        ...
        {/* ✅ NUEVO: Botón de escáner (COMENTADO) */}
        {/* 
        <TouchableOpacity
