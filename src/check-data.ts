...
async function checkData() {
  ...
  try {
    ...
    const [productosCount, clientesCount, pedidosCount, itemsCount, imagenesCount, usuariosCount] =
      await Promise.all([
    ...
    const total =
      productosCount + clientesCount + pedidosCount + itemsCount + imagenesCount + usuariosCount;
